      ...
      (d.initCore = function (f) {
        ...
        if (
          ...
          (d.options.doubleCheckInterval =
            d.options.doubleCheckInterval || 500),
          ...
          (d.log = function (t) {
            ...
            for (
              e
                ? ((o = (h = Array.prototype.slice.call(arguments)).shift()),
                  void 0 !== i.debug
                    ? i.debug.apply(i, [o, h])
                    : i.log.apply(i, [o, h]))
                : (o = "\n" + t + "\n"),
              ...
              if ("object" == typeof (l = arguments[r]) && void 0 !== u)
                try {
                  l = u.stringify(l);
                } catch (t) {}
              o += "\n" + l + "\n";
          ...
          (d.getInternetExplorerMajorVersion = function () {
            ...
            return (d.getInternetExplorerMajorVersion.cached =
              void 0 !== d.getInternetExplorerMajorVersion.cached
          ...
          (d.isInternetExplorer = function () {
            var t;
            return (d.isInternetExplorer.cached =
              void 0 !== d.isInternetExplorer.cached
                ? d.isInternetExplorer.cached
                : Boolean(d.getInternetExplorerMajorVersion()));
          }),
          d.options.html4Mode
                ...
                hashChange: Boolean(
                  !("onhashchange" in t || "onhashchange" in n) ||
                    (d.isInternetExplorer() &&
                      d.getInternetExplorerMajorVersion() < 8)
                ),
              }),
          ...
          (d.bugs = {
            ...
            ieDoubleCheck: Boolean(
              d.isInternetExplorer() && d.getInternetExplorerMajorVersion() < 8
            ),
            hashEscape: Boolean(
              d.isInternetExplorer() && d.getInternetExplorerMajorVersion() < 7
            ),
          }),
          ...
          (d.getBaseHref = function () {
            var t = n.getElementsByTagName("base"),
              ...
              i = "";
            return (
              1 === t.length && (i = (e = t[0]).href.replace(/[^\/]+$/, "")),
              (i = i.replace(/\/+$/, "")) && (i += "/"),
              i
            );
          }),
          ...
          (d.getPageUrl = function () {
            var t, e, i;
            return (i = ((d.getState(!1, !1) || {}).url || d.getLocationHref())
              .replace(/\/+$/, "")
          ...
          (d.getShortUrl = function (t) {
            var e = t,
              ...
              n = d.getRootUrl();
            return (
              d.emulated.pushState && (e = e.replace(i, "")),
              (e = e.replace(n, "/")),
          ...
          (d.getIdByState = function (t) {
            var e = d.extractId(t.url),
              i;
            if (!e)
              if (((i = d.getStateString(t)), void 0 !== d.stateToId[i]))
                e = d.stateToId[i];
                ...
                for (
                  ...
                  (e =
                    ...
                    void 0 !== d.idToState[e] ||
                      void 0 !== d.store.idToState[e];
            ...
            return (
              ...
              void 0 !== t.normalized
                ...
                : ((t.data && "object" == typeof t.data) || (t.data = {}),
                  ...
                  (d.emulated.pushState || d.bugs.safariPoll) &&
                    d.hasUrlDuplicate(e) &&
                    (e.url = e.hashedUrl),
                  e)
            );
          ...
          (d.extractState = function (t, e) {
            ...
            return (
              ...
              i ||
                ...
                !i &&
                  e &&
                  !d.isTraditionalAnchor(t) &&
                  (i = d.createStateObject(null, null, s))),
              i
            );
          }),
          ...
          (d.isLastSavedState = function (t) {
            var e = !1,
              ...
              s;
            return (
              d.savedStates.length &&
                (e = (i = t.id) === (s = (n = d.getLastSavedState()).id)),
              e
            );
          }),
          (d.saveState = function (t) {
            return (
              !d.isLastSavedState(t) &&
              (d.savedStates.push(d.cloneObject(t)), !0)
            );
          }),
          (d.getStateByIndex = function (t) {
            ...
            return (e =
              void 0 === t
                ? d.savedStates[d.savedStates.length - 1]
                : t < 0
                ? d.savedStates[d.savedStates.length + t]
                : d.savedStates[t]);
          }),
          (d.getCurrentIndex = function () {
            var t = null;
            return (t =
              d.savedStates.length < 1 ? 0 : d.savedStates.length - 1);
          }),
          ...
          (d.setHash = function (t, e) {
            ...
            return !1 !== e && d.busy()
              ? (d.pushQueue({
                ...
                !1)
              : (d.busy(!0),
                (i = d.extractState(t, !0)) && !d.emulated.pushState
                  ? d.pushState(i.data, i.title, i.url, !1)
                  : d.getHash() !== t &&
                    (d.bugs.setHash
                      ? ((s = d.getPageUrl()),
                        d.pushState(null, null, s + "#" + t, !1))
                      : (n.location.hash = t)),
                d);
          }),
          ...
          (d.setTitle = function (t) {
            var e = t.title,
              i;
            e ||
              ((i = d.getStateByIndex(0)) &&
                i.url === t.url &&
                (e = i.title || d.options.initialTitle));
            try {
          ...
          (d.busy = function (t) {
            if (
              (void 0 !== t
                ? (d.busy.flag = t)
                : void 0 === d.busy.flag && (d.busy.flag = !1),
              !d.busy.flag)
            ) {
              a(d.busy.timeout);
              var e = function () {
          ...
          (d.pushQueue = function (t) {
            return (
              (d.queues[t.queue || 0] = d.queues[t.queue || 0] || []),
          ...
          (d.doubleCheckClear = function () {
            return (
              d.doubleChecker && (a(d.doubleChecker), (d.doubleChecker = !1)), d
            );
          }),
          ...
          (d.go = function (t, e) {
            var i;
            if (t > 0) for (i = 1; i <= t; ++i) d.forward(e);
            else {
              if (!(t < 0))
                throw new Error(
          ...
          (d.onPopState = function (e, i) {
            ...
            return (
              ...
              (o = d.getHash())
                ? ((r = d.extractState(o || d.getLocationHref(), !0))
                    ? d.replaceState(r.data, r.title, r.url, !1)
                    : (d.Adapter.trigger(t, "anchorchange"), d.busy(!1)),
                  (d.expectedStateId = !1),
                  !1)
                : ((s = (n = d.Adapter.extractEventData("state", e, i) || !1)
                    ? d.getStateById(n)
                    : d.expectedStateId
                    ? d.getStateById(d.expectedStateId)
                    : d.extractState(d.getLocationHref())) ||
                    (s = d.createStateObject(null, null, d.getLocationHref())),
                  (d.expectedStateId = !1),
                  d.isLastSavedState(s)
                    ? (d.busy(!1), !1)
                    : (d.storeState(s),
                      d.saveState(s),
                      d.setTitle(s),
        ...
        d.Adapter.bind(t, "unload", d.clearAllIntervals),
          ...
          o &&
            ((d.onUnload = function () {
              ...
              d.idToState))
                d.idToState.hasOwnProperty(e) &&
                  (t.idToState[e] = d.idToState[e]);
              for (e in d.urlToId)
                d.urlToId.hasOwnProperty(e) && (t.urlToId[e] = d.urlToId[e]);
              for (e in d.stateToId)
                d.stateToId.hasOwnProperty(e) &&
                  (t.stateToId[e] = d.stateToId[e]);
            ...
            d.intervalList.push(h(d.onUnload, d.options.storeInterval)),
            d.Adapter.bind(t, "beforeunload", d.onUnload),
            d.Adapter.bind(t, "unload", d.onUnload)),
          d.emulated.pushState ||
            (d.bugs.safariPoll &&
              d.intervalList.push(
                h(d.safariStatePoll, d.options.safariPollInterval)
              ),
            ("Apple Computer, Inc." !== s.vendor &&
              "Mozilla" !== (s.appCodeName || "")) ||
      ...
      function (t, n, s, o) {
        function r() {
          ...
          o && !a && i(),
            ...
            o === e && u > t
              ? i()
              : !0 !== n && (a = setTimeout(o ? r : i, o === e ? t - u : t));
        }
        var a,
          h = 0;
        return (
          "boolean" != typeof n && ((o = s), (s = n), (n = e)),
  ...
  (function (t, e, i, n) {
    ...
    var u,
      ...
      d = {
        ...
        measure: {
          viewport: function () {
            h.viewport = { w: o.width(), h: o.height() };
          },
          fbElements: function () {
            var e = this,
              i = t(this.element),
    ...
    t.extend(s.prototype, {
      init: function () {
        ...
        if (
          ...
          (!e.instanceData || !e.instanceData.initialized) &&
            ...
            1 === i.children().length &&
            (i.children().is("img") ||
              (i.children().is("picture") && 1 === i.find("img").length)) &&
            "none" !== i.css("display") &&
            ...
            : (((a = new Image()).onload = function () {
                return (
                  ...
                  i
                    ...
                    .css({
                      zIndex:
                        e.settings.stackIndex + e.settings.stackIndexDelta,
                    }),
                  i.trigger("openstart.fluidbox"),
                  d.checkURL(a.src)
                    ? (e.close({ error: !0 }), !1)
      ...
      compute: function () {
        var e = this,
          ...
          l = e.instanceData.thumb.natH,
          u = e.instanceData.thumb.w,
          c = e.instanceData.thumb.h,
          d = a / l,
          p = h.viewport.w / h.viewport.h,
          f,
          g,
          m,
          v,
        ...
        e.settings.maxWidth > 0
          ? (l = (a = e.settings.maxWidth) / d)
          : e.settings.maxHeight > 0 && (a = (l = e.settings.maxHeight) * d),
          p > d
            ? ((v =
                (a *
                  ((c *
                    (m =
                      (f =
                        l < h.viewport.h
                          ? l
                          : h.viewport.h * e.settings.viewportFill) / c)) /
                    l)) /
                u),
              (y = m))
            : ((m =
                  ...
                  ((u *
                    (v =
                      (g =
                        a < h.viewport.w
                          ? a
                          : h.viewport.w * e.settings.viewportFill) / u)) /
                    a)) /
                c),
              (y = v)),
          e.settings.maxWidth &&
        ...
        var _ =
            ...
            c * (y - 1) * 0.5 +
            0.5 * (o.height() - c * y),
          w = u * (y - 1) * 0.5 + 0.5 * (o.width() - u * y) - n.offset().left,
      ...
      close: function (e) {
        var i = this,
          ...
          h = s.find(".fluidbox__overlay"),
          l = t.extend(null, { error: !1 }, e);
        return (
          null !== i.instanceData.state &&
          ...
          s
            .removeClass(function (t, e) {
              return (
                e.match(/(^|\s)fluidbox--(opened|loaded|loading)+/g) || []
              ).join(" ");
            })
            .addClass("fluidbox--closed"),
          r.css({
          ...
          l.error && r.trigger("transitionend"),
          void h.css({ opacity: 0 }))
        );
      },
      bindEvents: function () {
        var e = this,
        ...
        t(this.element).on("click.fluidbox", function (t) {
          t.preventDefault(),
            e.instanceData.state && 0 !== e.instanceData.state
              ? e.close()
              : e.open();
        });
      },
      bindListeners: function () {
        ...
        t.isFunction(t.throttle)
          ? o.on(
              "resize.fluidbox" + e.instanceData.id,
              t.throttle(e.settings.resizeThrottle, n)
            )
    ...
    (s.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (s.prototype.thumbnail = function (e, i) {
        ...
        if (
          ...
          return c(a.attr(h)), a.remove(), !1;
        "youtube" === i.type
          ? ((o = "//img.youtube.com/vi/" + i.id + "/hqdefault.jpg"), c(o))
          : "vimeo" === i.type
          ? t.ajax({
              type: "GET",
    ...
    function t(t) {
      return function (i, n) {
        var s = [],
          o = i;
        return (
          t.isFunction(i) && ((o = t.extend({}, n)).handler = i),
          this.each(function () {
            var i = t.extend({}, o, { element: this });
